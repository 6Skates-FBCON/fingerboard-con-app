...
-- ============================================================================
-- 4. DOCUMENTATION: Unused Indexes
-- ============================================================================

/*
  NOTE: All indexes are intentionally retained despite showing as "unused"
  
  Indexes appear unused because:
  1. Database is newly created with minimal test data
  2. Query patterns haven't been established yet in production
  
  These indexes are CRITICAL for production performance:
  - idx_profiles_role: Supports admin checks (used frequently by RLS)
  - idx_profiles_email: Supports user lookups by email
  - idx_tickets_*: Support ticket queries, QR scanning, validation
  - idx_transfers_*: Support transfer history and audit queries
  - idx_stripe_*: Support product catalog and pricing queries
  - idx_admin_users_active: Supports admin verification queries
  
  DO NOT REMOVE these indexes. They will be essential as data grows.
*/